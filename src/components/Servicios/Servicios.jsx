      ...
      <BannerTitles subtitle={"qué ofrecemos"} title={"Soluciones tu empresa"}/>
        <div className="flex flex-wrap servicios-cards">
          <div className="w-1/3 servicios-card">
            ...
            <Link to={"/servicios/1"}  className="servicios-card-btn  mt-5" onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})} >{t("area1.3")} </Link>
          </div>
          <div className="w-1/3 servicios-card">
            <div className="servicios-logo">
              <img src={AI} alt="icon" />
            ...
            <Link to={"/servicios/2"}  className="servicios-card-btn  mt-5" onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})} >{t("area2.3")}</Link>
          </div>
          <div className="w-1/3 servicios-card">
            <div className="servicios-logo">
            ...
            <Link to={"/servicios/3"}  className="servicios-card-btn  mt-5" onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})} >{t("area3.3")} </Link>
          </div>
        </div>
      </div>
    </div>
