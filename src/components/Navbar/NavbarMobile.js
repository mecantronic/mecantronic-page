    ...
    <div>
        <Accordion expanded={expanded === `panel1`} onChange={handleChange(`panel1`)} className='collapseItem1'>
            <AccordionSummary
                ...
                id={`panel1-bh-header`}>
                <p className='titleAccordionCollapse'>Servicios</p>
            </AccordionSummary>
            <AccordionDetails>
        ...
        <Accordion expanded={expanded === `panel2`} onChange={handleChange(`panel2`)} className='collapseItem1'>
            <AccordionSummary
                ...
                id={`panel2-bh-header`}>
                <p className='titleAccordionCollapse'>Productos</p>
            </AccordionSummary>
            <AccordionDetails>
                <a href="https://www.noisen.com.ar/" target="_blank" rel="noreferrer"  id='noisen'>
                    <span className='navItemCollapse'><p>Noisen</p></span>
                </a>
                <Link to={"/products/1"} id='kubox'><span className='navbar-collapseButton'  onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})} ><p>Kubox</p></span></Link>
                <Link to={"/products/2"} id='koron'><span className='navbar-collapseButton' onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})} ><p>Koron</p></span></Link>                
            </AccordionDetails>
        </Accordion>

        <div className='collapseItem1'>
            <Link to="/aboutUs" onClick={()=>window.scrollTo({top:0 , behavior:"smooth"})}>Nosotros</Link>
        </div>
